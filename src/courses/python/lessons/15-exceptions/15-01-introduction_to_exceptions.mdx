...
2.  The lines above it show the "call stack" – the sequence of code lines and function calls that were active when the error occurred, starting from the most recent call.
...
import pythonQuiz from "../../quiz-data/introduction_exception";
