...
One of Python's great strengths is its extensive **Standard Library** – a large collection of modules included with every Python installation. This "batteries included" philosophy means you often don't need to install external packages for many common programming tasks.
...
import pythonQuiz from "../../quiz-data/standard_library";
