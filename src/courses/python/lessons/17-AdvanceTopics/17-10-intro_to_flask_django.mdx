...
We've seen how Python can be used for scripting, data analysis, and making basic HTTP requests. A major application area for Python is also **web development** – building websites and web applications.
...
import pythonQuiz from "../../quiz-data/intro_to_flask";
