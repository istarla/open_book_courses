...
```
## Nested statement flow Diagram
<img src="/src/courses/python/images/nestedif.png" alt="variable" className="w-100 h-150 mx-auto" />
* **Key points:**
...
import pythonQuiz from "../../quiz-data/nested";
