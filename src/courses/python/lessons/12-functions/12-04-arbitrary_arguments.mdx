...
img_tag = build_tag("img", "", src="/src/courses/python/images/logo.png", alt="Logo") # Content is empty for img
print(img_tag) # Output: <img src="/src/courses/python/images/logo.png" alt="Logo" /> (Note: Self-closing tag logic not added here)
```
...
import pythonQuiz from "../../quiz-data/arbitrary_arguments";
